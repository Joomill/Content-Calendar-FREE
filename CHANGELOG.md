...
## 1.2.0 - 01/08/2026
- Note: this release jumps from 1.1.1 to 1.2.0 so the FREE module, the PRO package and the frontend module all carry the same version number from now on. The 1.1.2 that was prepared internally was never released; its changes are listed below.
